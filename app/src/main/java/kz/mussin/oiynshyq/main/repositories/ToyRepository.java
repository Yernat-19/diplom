package kz.mussin.oiynshyq.main.repositories;
...
public class ToyRepository {
    ...
    public ArrayList<Toy> fetchToys(Context context){
        this.context = context;
        ArrayList<Toy> toys = new ArrayList<>();
        reference = FirebaseDatabase.getInstance("https://oiynshyq-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference("toys");
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    Toy toy = gson.fromJson(ds.toString(), Toy.class);
                    toys.add(toy);
                }
            }
            @Override
